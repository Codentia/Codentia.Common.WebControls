...
{
    /// <summary>
    /// This class represents an Idempotent override of the asp.net Button
    /// </summary>
    [ToolboxData("<{0}:IdempotentButton runat=server></{0}:IdempotentButton>")]
    public class IdempotentButton : Button
    {
